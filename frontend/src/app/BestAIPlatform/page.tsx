  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 z-10">
        <button
          onClick={() => router.push("/")}
          className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 hover:bg-white/10 rounded-lg text-white shadow-lg transition-all duration-300"
        >
          <FaArrowLeft />
          Home
        </button>
      </div>
      <div className="max-w-2xl mx-auto bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl border border-yellow-500/30 p-10 text-center relative z-10">
        <div className="flex flex-col items-center mb-6">
          <FaTrophy className="text-yellow-400 text-6xl mb-4 animate-bounce-slow" />
          <h1 className="text-4xl font-extrabold bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-500 bg-clip-text text-transparent mb-2">
            Best AI Platform 2026
          </h1>
          <span className="text-lg text-amber-300 font-semibold mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6 flex flex-col items-center">
            <FaChartLine className="text-amber-400 text-3xl mb-2" />
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6 flex flex-col items-center">
            <FaShieldAlt className="text-orange-400 text-3xl mb-2" />
        ...
        <div className="flex justify-center mb-8">
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-amber-600 rounded-xl font-bold text-black shadow-lg hover:scale-105 transition-transform duration-300 flex items-center gap-2"
          >
            <FaRocket />
            Explore Platform
          </button>
        </div>
        <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 border border-yellow-400/20 rounded-xl p-6 shadow text-center">
